...
func Run(cfgPath string) {
	...
	contractUC := contractUc.NewContractUsecase(contractTmplRepo, contractDbRepo, contractSigningRepo, contractEmpFetcher, contractDesFetcher, contractSalFetcher)
	shiftTimeFetcher := contractAdapter.NewShiftTimeFetcherAdapter(workPatternRepo, ewpRepo)
	contractCompFetcher := contractAdapter.NewCompensationFetcherAdapter(payrollEmpCompRepo, payrollCompItemRepo)
	contractBenefitFetcher := contractAdapter.NewBenefitFetcherAdapter(payrollEmpBenefitRepo, payrollBenefitTypeRepo)
	contractDeductionFetcher := contractAdapter.NewDeductionFetcherAdapter(payrollEmpDeductionRepo, payrollDeductionTypeRepo)
	contractRenderUC := contractUc.NewRenderUsecase(contractDbRepo, contractSigningRepo, contractEmpFetcher, shiftTimeFetcher, contractCompFetcher, contractBenefitFetcher, contractDeductionFetcher, contractAdapter.NewChromedpRenderer())
	...
	contractDesAssigner := contractAdapter.NewDesignationAssignerAdapter(emplRepo)
	...
	contractSignUC := contractUc.NewSigningUsecase(db, contractDbRepo, contractSigningRepo, contractDocUC, contractEmpFetcher, contractEmpActivator, contractWPAssigner, contractDesAssigner, contractUserActivator, contractEmpTerminator)
