...
const (
	ActionPatternCreate = "schedule.pattern.create"
	ActionPatternUpdate = "schedule.pattern.update"
	ActionPatternDelete = "schedule.pattern.delete"
	ActionAssign        = "schedule.assign"
	ActionOverride      = "schedule.override"
)
